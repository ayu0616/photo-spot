...
export default function EditTripForm({
  ...
  // 初期状態で trip.posts に含まれるIDを選択状態にする
  ...
  // 日付範囲に基づいて投稿を取得する
  // initialData を使うことで、初回レンダリング時のフェッチを防ぐ（サーバーから渡されたデータを使用）
  const {
    data: postsData,
    ...
    // 初回表示時はサーバーから受け取った props.initialPosts を使う
    // 日付が変更された場合のみ再フェッチが走るようにキー管理される
  ...
  // postsData が undefined の場合のフォールバック
